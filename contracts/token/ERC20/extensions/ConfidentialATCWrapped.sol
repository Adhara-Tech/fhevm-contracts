    ...
    GatewayCaller
{
    ...
    IConfidentialATC public immutable ATC_TOKEN;
    ...
    {
        ATC_TOKEN = IConfidentialATC(atc);
    ...
    function wrap(uint256 amount) public virtual {
        ATC_TOKEN.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function callbackUnwrap(uint256 requestId, bool canUnwrap) public virtual nonReentrant onlyGateway {
        ...
        if (canUnwrap) {
            ...
            try ATC_TOKEN.transfer(unwrapRequest.account, amountUint256) {
