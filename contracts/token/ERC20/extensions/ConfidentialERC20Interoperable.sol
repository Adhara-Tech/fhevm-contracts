 ...
 */
abstract contract ConfidentialERC20Interoperable is Ownable2Step, ConfidentialERC20WithErrorsMintable {
    /**
    ...
    constructor(
        ...
        address owner_
    ) Ownable(owner_) ConfidentialERC20WithErrorsMintable(name_, symbol_) {}
